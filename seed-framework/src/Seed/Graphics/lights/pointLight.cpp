...
PointLight::PointLight(const std::string &n, const glm::vec3 &p, const glm::vec3 &K2, const glm::vec3 &c, const float &near, const float &far, const float &att) : Light(n, c)
{
	this->position = p;
