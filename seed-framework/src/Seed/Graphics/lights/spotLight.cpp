...
SpotLight::SpotLight(const std::string &n, const glm::vec3 &p, const glm::vec3 &dir, const glm::vec3 &K2, const glm::vec3 &c,const float &ang, const float &near, const float &far) : Light(n, c)
{
	this->position = p;
	this->direction = dir;
	this->angle = ang;
