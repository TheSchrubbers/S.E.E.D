...
class DefaultMaterial : public Material
{
	public:
		...
		*/
		DefaultMaterial(const aiMaterial *material, Scene *scene, std::string name, unsigned int *flag = __nullptr, const float reflec = 0.0, const float refrac = 0.0);
		/*!
		* \brief Constructor of class DefaultMaterial
		...
		* \param flag: pointer of an int to get any errors
		*/
		DefaultMaterial(Scene *scene, const std::string name, unsigned int *flag = __nullptr, const float reflec = 0.0, const float refrac = 0.0);
