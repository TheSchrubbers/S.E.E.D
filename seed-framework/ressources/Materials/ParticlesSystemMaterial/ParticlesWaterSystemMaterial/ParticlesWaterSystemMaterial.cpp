...
ParticlesWaterSystemMaterial::ParticlesWaterSystemMaterial(Scene *sce, const int &nb, const std::string n, unsigned int *flag) : Material(sce, n, 0.0, 0.0, pathToParticlesWaterSystemMaterial + "Shaders", flag)
{
	this->nbParticles = nb;
	this->init();
